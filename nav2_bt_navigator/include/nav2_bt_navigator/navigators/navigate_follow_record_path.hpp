...
#ifndef NAV2_BT_NAVIGATOR__NAVIGATORS__FOLLOW_RECORD_PATH_HPP_
#define NAV2_BT_NAVIGATOR__NAVIGATORS__FOLLOW_RECORD_PATH_HPP_
...
/**
 * @class NavigateFollowRecordPathNavigator
 * @brief A navigator for navigating to a specified pose
 */
class NavigateFollowRecordPathNavigator
  : public nav2_bt_navigator::Navigator<yhs_can_interfaces::action::RecordPath>
{
public:
  using ActionT = yhs_can_interfaces::action::RecordPath;

  /**
   * @brief A constructor for NavigateFollowRecordPathNavigator
   */
  NavigateFollowRecordPathNavigator()
  : Navigator() {}
   ...
   */
  void onGoalPoseReceived(const nav_msgs::msg::Path::SharedPtr path);

  /**
   * @brief Get action name for this navigator
   * @return string Name of action server
   */
  std::string getName() {return std::string("navigate_follow_record_path");}
...
#endif  // NAV2_BT_NAVIGATOR__NAVIGATORS__FOLLOW_RECORD_PATH_HPP_

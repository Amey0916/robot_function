...
public:
  ...
  void onGoalPoseCancel(const std_msgs::msg::String::SharedPtr cancel_msg);
...
protected:
  ...
  rclcpp_action::ClientGoalHandle<ActionT>::SharedPtr goal_pose_handle_;

  rclcpp::Subscription<geometry_msgs::msg::PoseStamped>::SharedPtr goal_sub_;
  rclcpp::Subscription<std_msgs::msg::String>::SharedPtr goal_cancel_sub_;

  ...
  std::shared_ptr<nav2_util::OdomSmoother> odom_smoother)
{
  ...
  goal_cancel_sub_ = node->create_subscription<std_msgs::msg::String>(
    "goal_pose/cancel",
    rclcpp::SystemDefaultsQoS(),
    std::bind(&NavigateToPoseNavigator::onGoalPoseCancel, this, std::placeholders::_1));
...
void
NavigateToPoseNavigator::onGoalPoseCancel(const std_msgs::msg::String::SharedPtr cancel_msg)
{
  RCLCPP_WARN(logger_,"Cancel goal_pose nav. %s",cancel_msg->data.c_str());

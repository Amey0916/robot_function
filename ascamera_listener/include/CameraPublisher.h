...
typedef struct PUBLISHER_INFO {
    ...
    rclcpp::Publisher<sensor_msgs::msg::Image>::SharedPtr peak_img_raw_pub;
    ...
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr depth_odd_points_pub;
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr depth_even_points_pub;
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr depth_merge_points_pub;

    rclcpp::Publisher<sensor_msgs::msg::Image>::SharedPtr peak_odd_img_raw_pub;
    rclcpp::Publisher<sensor_msgs::msg::Image>::SharedPtr peak_even_img_raw_pub;

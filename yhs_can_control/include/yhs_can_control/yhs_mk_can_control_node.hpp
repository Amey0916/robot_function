#ifndef __YHS_MK_CAN_CONTROL_NODE_H__
#define __YHS_MK_CAN_CONTROL_NODE_H__
...
#include "yhs_can_interfaces/msg/mk_io_cmd.hpp"
#include "yhs_can_interfaces/msg/mk_ctrl_cmd.hpp"
#include "yhs_can_interfaces/msg/mk_chassis_info_fb.hpp"
...
namespace can_control
{
  ...
  public:
    MkCanControl(rclcpp::Node::SharedPtr);
    ~MkCanControl();
  ...
  private:
    ...
    double imu_roll_, imu_pitch_, imu_yaw_, wheel_base_;

    std::shared_ptr<tf2_ros::TransformBroadcaster> tf_broadcaster_;

    rclcpp::Subscription<yhs_can_interfaces::msg::MkIoCmd>::SharedPtr io_cmd_subscriber_;
    rclcpp::Subscription<yhs_can_interfaces::msg::MkCtrlCmd>::SharedPtr ctrl_cmd_subscriber_;
    ...
    rclcpp::Publisher<yhs_can_interfaces::msg::MkChassisInfoFb>::SharedPtr chassis_info_fb_publisher_;
    rclcpp::Publisher<nav_msgs::msg::Odometry>::SharedPtr odom_pub_;

    void MkIoCmdCallBack(const yhs_can_interfaces::msg::MkIoCmd::SharedPtr io_cmd_msg);

    void MkCtrlCmdCallBack(const yhs_can_interfaces::msg::MkCtrlCmd::SharedPtr ctrl_cmd_msg);
    ...
    void PublishOdom(const double velocity, const double steering);
  };

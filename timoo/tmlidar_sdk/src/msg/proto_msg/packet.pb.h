...
class LidarPacket PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:proto_msg.LidarPacket) */ {
 public:
  inline LidarPacket() : LidarPacket(nullptr) {};
  virtual ~LidarPacket();
  ...
  inline void Swap(LidarPacket* other) {
  ...
  void UnsafeArenaSwap(LidarPacket* other) {
    if (other == this) return;
  ...
  inline LidarPacket* New() const final {
    return CreateMaybeMessage<LidarPacket>(nullptr);
  }

  LidarPacket* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "proto_msg.LidarPacket";
  }
  protected:
  explicit LidarPacket(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
...
// optional bytes data = 1;
inline bool LidarPacket::_internal_has_data() const {
...
inline const std::string& LidarPacket::_internal_data() const {
  return data_.Get();
}
inline void LidarPacket::_internal_set_data(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
...
inline void LidarPacket::set_data(const void* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
...
inline std::string* LidarPacket::_internal_mutable_data() {
  _has_bits_[0] |= 0x00000001u;
...
inline std::string* LidarPacket::unsafe_arena_release_data() {
  // @@protoc_insertion_point(field_unsafe_arena_release:proto_msg.LidarPacket.data)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000001u;
  return data_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void LidarPacket::unsafe_arena_set_allocated_data(
    std::string* data) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (data != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  ...
  data_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      data, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:proto_msg.LidarPacket.data)
}

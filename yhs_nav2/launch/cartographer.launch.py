...
def generate_launch_description():
    ...
    # lidar launch config
    # lidar_launch_dir = os.path.join(get_package_share_directory('tmlidar_sdk'),'launch')
    ...
    declare_use_tf_cmd = DeclareLaunchArgument('use_tf', default_value='false', description='is use_tf?')
    ...
    bringup_cmd_group = GroupAction([
        ...
        # #激光雷达节点                  
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(lidar_launch_dir, 'rplidar_s2_cartographer_launch.py')),
            launch_arguments={'namespace': namespace,
                              'use_sim_time': use_sim_time,
                              'autostart': autostart,
                              'use_respawn': use_respawn}.items()),
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(cartographer_launch_dir, 'dgt_mini.launch.py')),
            launch_arguments={'namespace': namespace,
                              'use_sim_time': use_sim_time,
                              'autostart': autostart,
                              'use_respawn': use_respawn}.items()),
